 ...
 * @author ASUS
 */
public class bahamut extends character{
    player p;
    ...
    int move;
    int time=0;
    public bahamut(handler handler, float x, float y) {
        ...
        anidown = new animation(200,assets.bahamut_down);
        aniup = new animation(200,assets.bahamut_up);
        anileft = new animation(200,assets.bahamut_left);
        aniright = new animation(200,assets.bahamut_right);        
