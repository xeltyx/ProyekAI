...
public class worm extends character{
    ...
    int move;
    int time=0;
    public worm(handler handler, float x, float y) {
        ...
        anidown = new animation(200,assets.worm_down);
        aniup = new animation(200,assets.worm_up);
        anileft = new animation(200,assets.worm_left);
        aniright = new animation(200,assets.worm_right);        
