 ...
 * @author ASUS
 */
public class zombiemage extends character{
    player p;
    ...
    int move;
    int time=0;
    public zombiemage(handler handler, float x, float y) {
        ...
        anidown = new animation(200,assets.zombiemage_down);
        aniup = new animation(200,assets.zombiemage_up);
        anileft = new animation(200,assets.zombiemage_left);
        aniright = new animation(200,assets.zombiemage_right);        
    ...
    private BufferedImage getCurrentAnimation(){
        ...
        {
            if(up)
               return assets.zombiemage_dieup[dieindex];
            else if(down)
                return assets.zombiemage_diedown[dieindex];
            else if(right)
                return assets.zombiemage_dieright[dieindex];
            else if(left)
                return assets.zombiemage_dieleft[dieindex];
        }
        else if(attanimation)
        {
            if(up)
            {
                return assets.zombiemage_attup[index];
            }
            else if(left)
            {
                return assets.zombiemage_attleft[index];
            }
            else if(right)
            {
                return assets.zombiemage_attright[index];
            }
            else if(down)
            {
                return assets.zombiemage_attdown[index];
            }
        }
        else if(moveup)
        {
