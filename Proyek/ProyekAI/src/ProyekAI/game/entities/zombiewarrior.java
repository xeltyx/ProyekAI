 ...
 * @author ASUS
 */
public class zombiewarrior extends character{
    player p;
    ...
    int move;
    int time=0;
    public zombiewarrior(handler handler, float x, float y) {
        ...
        anidown = new animation(200,assets.zombiewarrior_down);
        aniup = new animation(200,assets.zombiewarrior_up);
        anileft = new animation(200,assets.zombiewarrior_left);
        aniright = new animation(200,assets.zombiewarrior_right);        
    ...
    private BufferedImage getCurrentAnimation(){
        ...
        {
            if(up)
               return assets.zombiewarrior_dieup[dieindex];
            else if(down)
                return assets.zombiewarrior_diedown[dieindex];
            else if(right)
                return assets.zombiewarrior_dieright[dieindex];
            else if(left)
                return assets.zombiewarrior_dieleft[dieindex];
        }
        else if(attanimation)
        {
            if(up)
            {
                return assets.zombiewarrior_attup[index];
            }
            else if(left)
            {
                return assets.zombiewarrior_attleft[index];
            }
            else if(right)
            {
                return assets.zombiewarrior_attright[index];
            }
            else if(down)
            {
                return assets.zombiewarrior_attdown[index];
            }
        }
        else if(moveup)
        {
