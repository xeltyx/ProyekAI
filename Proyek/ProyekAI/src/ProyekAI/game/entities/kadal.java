 ...
 * @author ASUS
 */
public class kadal extends character{
    player p;
    ...
    int move;
    int time=0;
    public kadal(handler handler, float x, float y) {
        ...
        anidown = new animation(200,assets.kadal_down);
        aniup = new animation(200,assets.kadal_up);
        anileft = new animation(200,assets.kadal_left);
        aniright = new animation(200,assets.kadal_right);        
    ...
    private BufferedImage getCurrentAnimation(){
        ...
        {
            if(up)
               return assets.kadal_dieup[dieindex];
            else if(down)
                return assets.kadal_diedown[dieindex];
            else if(right)
                return assets.kadal_dieright[dieindex];
            else if(left)
                return assets.kadal_dieleft[dieindex];
        }
        else if(attanimation)
        {
            if(up)
            {
                return assets.kadal_attup[index];
            }
            else if(left)
            {
                return assets.kadal_attleft[index];
            }
            else if(right)
            {
                return assets.kadal_attright[index];
            }
            else if(down)
            {
                return assets.kadal_attdown[index];
            }
        }
        else if(moveup)
        {
