 ...
 * @author ASUS
 */
public class sabertooth extends character{
    player p;
    ...
    int move;
    int time=0;
    public sabertooth(handler handler, float x, float y) {
        ...
        anidown = new animation(200,assets.sabertooth_down);
        aniup = new animation(200,assets.sabertooth_up);
        anileft = new animation(200,assets.sabertooth_left);
        aniright = new animation(200,assets.sabertooth_right);        
    ...
    private BufferedImage getCurrentAnimation(){
        if(attanimation)
        {
            if(up)
            {
                return assets.sabertooth_attup[index];
            }
            else if(left)
            {
                return assets.sabertooth_attleft[index];
            }
            else if(right)
            {
                return assets.sabertooth_attright[index];
            }
            else if(down)
            {
                return assets.sabertooth_attdown[index];
            }
        }
        else if(moveup)
        {
