...
public class minotaur extends character{
    ...
    int move;
    int time=0;
    public minotaur(handler handler, float x, float y) {
        ...
        anidown = new animation(200,assets.minotaur_down);
        aniup = new animation(200,assets.minotaur_up);
        anileft = new animation(200,assets.minotaur_left);
        aniright = new animation(200,assets.minotaur_right);        
