...
public class skeleton extends character{
    ...
    public skeleton(handler handler, float x, float y) {
        ...
        anidown = new animation(200,assets.skeleton_down);
        aniup = new animation(200,assets.skeleton_up);
        anileft = new animation(200,assets.skeleton_left);
        aniright = new animation(200,assets.skeleton_right);        
    ...
    private BufferedImage getCurrentAnimation(){
        ...
        {
            if(up)
               return assets.skeleton_dieup[dieindex];
            else if(down)
                return assets.skeleton_diedown[dieindex];
            else if(right)
                return assets.skeleton_dieright[dieindex];
            else if(left)
                return assets.skeleton_dieleft[dieindex];
        }
        else if(attanimation)
        {
            if(up)
            {
                return assets.skeleton_attup[index];
            }
            else if(left)
            {
                return assets.skeleton_attleft[index];
            }
            else if(right)
            {
                return assets.skeleton_attright[index];
            }
            else if(down)
            {
                return assets.skeleton_attdown[index];
            }
        }
        else if(moveup)
        {
