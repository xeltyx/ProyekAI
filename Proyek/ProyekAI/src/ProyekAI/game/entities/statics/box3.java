 ...
 * @author ASUS
 */
public class box3 extends StaticEntity{
     public box3(handler handler,  float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(assets.box3,(int) (x - handler.getGamecamera().getX()),(int) (y - handler.getGamecamera().getY()), width,height,null);
    }
}
