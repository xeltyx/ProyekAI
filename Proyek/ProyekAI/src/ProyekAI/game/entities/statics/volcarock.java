 ...
 * @author USER
 */
public class volcarock extends StaticEntity{
    public volcarock(handler handler,  float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(assets.redrock,(int) (x - handler.getGamecamera().getX()),(int) (y - handler.getGamecamera().getY()), width,height,null);
    }
}
