...
public class pixie extends character{
    ...
    int move;
    int time=0;
    public pixie(handler handler, float x, float y) {
        ...
        anidown = new animation(200,assets.pixie_down);
        aniup = new animation(200,assets.pixie_up);
        anileft = new animation(200,assets.pixie_left);
        aniright = new animation(200,assets.pixie_right);        
